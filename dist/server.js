...
// src/services/list-eposides-service.ts
...
var DEFAULT_CONTENT = { "Content-Type": "application/json" };
var getListEpisodes = (request, response) => __async(void 0, null, function* () {
  ...
  response.write(JSON.stringify((yield serviceListEpisodes()).body));
  response.end();
});
...
var app = (request, response) => __async(void 0, null, function* () {
  ...
  if (request.method === "GET" /* GET */ && baseUrl === "/api/episode" /* EPISODES */) {
